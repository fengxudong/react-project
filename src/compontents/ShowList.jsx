...
export default class ShowList extends Component {
    ...
    render() {
        return (
            <div className={style.library_wrap} style={this.props.location.pathname === '/show/ShowCategoryList'?{background: 'linear-gradient(0deg, #f0f0f0, #f0f0f0, #fefefe)'}:{background:''}}>
                {
